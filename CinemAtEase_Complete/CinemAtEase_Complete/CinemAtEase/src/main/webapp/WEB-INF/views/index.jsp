                    ...
                    <div class="item">
                        <li>
                            <div class="slider-info banner-view bg bg2" style="background: url('${m.banner}') no-repeat;background-size:100% 100%;">
                                ...
                                <h3>${m.mname} </h3>
                                <!-- <video playsinline loop autoplay="true" preload="auto" class="_2jpqF0Dm82MJm9bY_XUhOQ">
                                    <source type="video/mp4" src="https://img1.hotstarext.com/video/upload/sources/r1/cms/animations/1on5cf_1587393232549">
                                </video> -->
                                    <p>${m.descr}.</span></p>
                        ...
                        <div class="item vhny-grid">
                            ...
                            <a href="mdetails/${m.mid }">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <h4> <span class="post">
                                            <!-- <span class="fa fa-clock-o"> </span> 1 Hr 4min</span>
                    ...
                    <div class="owl-three owl-carousel owl-theme">
                        ...
                        <div class="item vhny-grid">
                            ...
                            <a href="mdetails/${m.mid }">
                                    ...
                                    <div class="box-content">
                                        <h3 class="title">${m.mname }</h3>
                                        <h4>  <!-- <span class="fa fa-clock-o"> </span> 1 Hr 4min</span>
