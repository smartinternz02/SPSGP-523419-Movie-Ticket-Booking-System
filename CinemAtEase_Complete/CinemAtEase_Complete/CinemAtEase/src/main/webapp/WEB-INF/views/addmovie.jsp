        ...
        <div class="col-sm-7">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-sm-8">
                        <input type="file" accept=".jpg,.png,.mp4,.webp" required class="form-control-file" name="photo">
                    </div>
                </div>
                <div class="form-group form-row">
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-sm-8">
                        <input type="file" accept=".jpg,.png,.mp4,.webp" required class="form-control-file" name="bphoto">
                    </div>
                </div>
